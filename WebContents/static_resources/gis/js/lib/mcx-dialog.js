...
var mcxDialog = {
	...
	toast2: function toast(content, time, mleft, mtop) {
		time = time || 3;
		var toast = document.createElement("div");
		var toastContent = document.createElement("div");
		...
		addClass(toast, "animation-fade-in");
		addClass(toastContent, "toast-content");
		addClass(toastContent, "custom-radius");
		...
		toast.style.fontSize = getFontSize();
		toast.style.left = mleft+"px";
		toast.style.top = mtop+"px";
		//toast.style.left = (document.documentElement.clientWidth - toast.offsetWidth) / 2 + "px";
	...
	toast3: function toast(content, time, mleft, mtop) {
		time = time || 3;
		var toast = document.createElement("div");
		var toastContent = document.createElement("div");
			toastContent.setAttribute("id","timepanel");
	...
	loadingWth: function loading(options) {
		var opts = {
			src: "img",
			hint: ""
		};
