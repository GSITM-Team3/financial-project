...
<body class="page-body">
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <div>
                <h1>공지사항 목록</h1>
                <a href="/share_th/createNoticeView_th" class="btn btn-primary">공지사항
                    등록</a>
                <hr>
                ...
                <table class="table" id="grid_app">
                    ...
                    <tbody>
                        <c:forEach var="notice" items="${noticeList}">
                            <tr>
                                <td>${notice.gw_code}</td>
                                <td><a href="/share_th/noticeOne/${notice.gw_code}">${notice.gw_title}</a></td>
                                <td>${notice.gw_created_at}</td>
