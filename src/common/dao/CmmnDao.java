...
public class CmmnDao extends SqlSessionDaoSupport {
   ...
   @SuppressWarnings("unchecked")
   public <E> PageList<E> selectListPage(String queryId, PagingConfig pagingConfig) {
      PageList<E> pageList = (PageList<E>) getSqlSession().selectList(queryId, null, new PageBounds(pagingConfig));
      int startCurNum = CmmnUtil.getStartCurNum(pageList);
      for(E e : pageList) {
         if(e instanceof Map) {
            ((Map) e).put("rownum", startCurNum);
            startCurNum--;
         }
      }
      return pageList;
   ...
   @SuppressWarnings("unchecked")
   public <E> PageList<E> selectListPage(String queryId, Object parameterObject, PagingConfig pagingConfig) {
      PageList<E> pageList = (PageList<E>) getSqlSession().selectList(queryId, parameterObject, new PageBounds(pagingConfig));
      int startCurNum = CmmnUtil.getStartCurNum(pageList);
      for(E e : pageList) {
         if(e instanceof Map) {
            ((Map) e).put("rownum", startCurNum);
   ...
   public List<CmmnMap> selectConsultList(String queryId, int parameter) {
